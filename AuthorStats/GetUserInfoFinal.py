...
cursor.execute("SELECT digg_id FROM diggs_final ")
...
for i in range(1, total_rows):
    ...
    if data['count'] != 0:
        ...
        #=======================================================================
        try :    
            cursor2.execute("INSERT INTO digg_final_jaison(digg_id, diggs , fofCount , authorDiggs , authorComments , authorFans , authorFollows, authorGender , authorSubmissions ) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)",(story_id , diggs_of_story , fof , diggs , comments , followers , following , gender , submissions))
